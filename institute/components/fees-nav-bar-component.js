    ...
    <div class="notice-text">
        ...
        <aside id="sidebar" class="sidebar">
          <ul class="nav nav-pills flex-column mb-auto sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
              <a class="nav-link" href="institute/dashboard.html" id="dashboard-link">
            ...
            <li class="nav-item">
              <a class="nav-link index-link" href="institute/special_scheme_fee.html" id="special-scheme-fees-link">
                <i class="bi bi-pencil-square"></i> 
                <span data-i18n='fee-list'>Transport Fees Entry</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="institute/beneficiary_management.html" id="approve-list-link">
                <i class="bi bi-graph-up"></i>
                <span data-i18n='student-management'>Scholarship Management</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="institute/search.html" id="search-link">
            ...
            <li class="nav-item">
                <a class="nav-link" href="institute/fees_generic_report.html" id="report-link">
            ...
            <ul id="ppstps-submenu" class="collapse list-unstyled">
              <li class="nav-item">
                <a class="nav-link" href="institute/pps-tps-summary.html" id="ppstps-summary-link">
                  <i class="bi bi-columns"></i>PPS/TPS Dashboard
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="institute/pps-tps-reports.html" id="ppstps-reports-link">
                  <i class="bi bi-card-list"></i>
                  Reports
                </a>
              </li>
...
.date {
  ...
  setActiveLink() {
    ...
    if (currentUrl.includes("institute/generic_report.html") && prefId && prefType) {
      const submenuId = prefType === 'fixed' ? 'fixed-reports-submenu' : 'custom-reports-submenu';
      const prefLink = document.querySelector(`#bkmark-${prefId}`);
      if (prefLink) {
    ...
    const urlToNavMap = {
      "institute/dashboard.html": "dashboard-link",
      "institute/beneficiary_management.html": "approve-list-link",
      "institute/student_apply.html": "student-apply-link",
      "institute/report-list.html": "report-list-link",
      "institute/all_schemes.html": "all-schemes-link",
      "institute/student-eligibility-reports.html": "student-eligibility-reports-link",
      "institute/institute-eligibility-report.html": "institute-eligibility-report-link",
      "institute/ineligible_student_list.html": "ineligible-student-list-link",
      "institute/student-reports.html": "student-reports-link",
      "institute/student-linelist.html": "student-linelist-link",
      "institute/institute_download_reports_all.html": "institute-download-reports-link",
      "institute/search.html": "search-link",
      "institute/fees_generic_report.html": "report-link",
      "index.html": "fees-link",
      "institute/special_scheme_fees.html": "special-scheme-fees-link",
    };
          ...
          success: (response) => {
            if (response.success) {
              ...
              if (headerSidebar && typeof headerSidebar.populateReportSubmenus === 'function') {
                headerSidebar.populateReportSubmenus(university_id_decode);
              }
            } else {
              Swal.fire(
                'Error!',
        ...
        success: (response) => {
          ...
          try {
            ...
            preferences.forEach(pref => {
              submenuElement.innerHTML += `
                <li class="nav-item d-flex align-items-center">
                  <a class="nav-link flex-grow-1" href="institute/generic_report.html" id="bkmark-${pref.id}" data-pref-id="${pref.id}" data-pref-type="${submenu.typeName}">
                    <i class="bi bi-bookmark-check"></i>
